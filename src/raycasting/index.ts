...
export class Raycaster {
  ...
  setFromCamera(ndc: [number, number], camera: PerspectiveCamera): void {
    ...
    // Transform view-space direction to world space via inverse of view matrix rotation.
    // The view matrix's 3x3 rotation is orthonormal, so its inverse is its transpose.
