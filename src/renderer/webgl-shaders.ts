...
//
// Transparency uses sorted back-to-front alpha blending. Transparent meshes are drawn
// in the same MSAA pass as opaque meshes, reusing the same shaders but with alpha blend
// enabled, depth writes disabled, and back-face culling off.
//
