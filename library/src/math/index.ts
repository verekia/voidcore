...
export const mat4MultiplyInto = (out: Float32Array, offset: number, a: Mat4, b: Mat4): void => {
  ...
  b2 = b[6]!
  b3 = b[7]!
  out[offset + 4] = b0 * a00 + b1 * a10 + b2 * a20 + b3 * a30
  out[offset + 5] = b0 * a01 + b1 * a11 + b2 * a21 + b3 * a31
  out[offset + 6] = b0 * a02 + b1 * a12 + b2 * a22 + b3 * a32
  out[offset + 7] = b0 * a03 + b1 * a13 + b2 * a23 + b3 * a33

  b0 = b[8]!
  b1 = b[9]!
  b2 = b[10]!
  b3 = b[11]!
  out[offset + 8] = b0 * a00 + b1 * a10 + b2 * a20 + b3 * a30
  out[offset + 9] = b0 * a01 + b1 * a11 + b2 * a21 + b3 * a31
  out[offset + 10] = b0 * a02 + b1 * a12 + b2 * a22 + b3 * a32
  out[offset + 11] = b0 * a03 + b1 * a13 + b2 * a23 + b3 * a33

  b0 = b[12]!
  b1 = b[13]!
  b2 = b[14]!
  b3 = b[15]!
  out[offset + 12] = b0 * a00 + b1 * a10 + b2 * a20 + b3 * a30
  out[offset + 13] = b0 * a01 + b1 * a11 + b2 * a21 + b3 * a31
  out[offset + 14] = b0 * a02 + b1 * a12 + b2 * a22 + b3 * a32
  out[offset + 15] = b0 * a03 + b1 * a13 + b2 * a23 + b3 * a33
}
