...
library/       – The library package (published to npm as "voidcore")
  src/
    ...
    helpers/             – Visual debug helpers (DirectionalLightHelper, GIProbeHelper)
    ...
    scene/               – Scene graph nodes (Node, Scene, Mesh, Group, Camera, Light, GI probes)
